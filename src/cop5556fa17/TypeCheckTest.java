...
public class TypeCheckTest {
	...
	/**
	 * Added for expression
	 */
	void typeCheckExpr(String input) throws Exception {
		show(input);
		try {
			Scanner scanner = new Scanner(input).scan();
			ASTNode ast = new Parser(scanner).expression();
			show(ast);
			ASTVisitor v = new TypeCheckVisitor();
			ast.visit(v, null);
		} catch (Exception e) {
	...
	@Test
	public void test2_jagan() throws Exception {
		String input = "prog image[5,10] imageName;";
		typeCheck(input);
	}
	
	@Test
	public void test1_jagan() throws Exception {
		String input = "prog image img1; image img2 <- @123;"
				+ "image [10,15] img3<- \"hello\";\n"
				+ "int v; int b = 10+20; boolean c = true;\n"
				+ "v [[r,a]] = b; v = sin[r+10,a+20];";
		typeCheck(input);
	}
	
	@Test
	public void test3_jagan() throws Exception {
		String input = "prog boolean k = 3 == 4;";
		typeCheck(input);
	}
	
	@Test
	public void test4_jagan() throws Exception {
